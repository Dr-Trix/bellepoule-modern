...
const PoolView = ({ pool, maxScore = 5, weapon, onScoreUpdate, onFencerChangePool }) => {
    ...
    const renderNextMatch = () => {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { style: {
                ...
                marginTop: '1rem',
                color: 'white'
            }, children: (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: '0.75rem', textTransform: 'uppercase', opacity: 0.8 }, children: "\u2694\uFE0F Prochain match" }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: '0.75rem', flex: 1, justifyContent: 'center' }, children: [(0, jsx_runtime_1.jsxs)("span", { style: { fontWeight: '600' }, children: [nextMatch.match.fencerA?.lastName, " ", nextMatch.match.fencerA?.firstName?.charAt(0), "."] }), (0, jsx_runtime_1.jsx)("span", { style: { opacity: 0.7 }, children: "vs" }), (0, jsx_runtime_1.jsxs)("span", { style: { fontWeight: '600' }, children: [nextMatch.match.fencerB?.lastName, " ", nextMatch.match.fencerB?.firstName?.charAt(0), "."] })] }), (0, jsx_runtime_1.jsx)("button", { onClick: () => openScoreModal(nextMatch.index), style: {
                            padding: '0.5rem 1rem',
