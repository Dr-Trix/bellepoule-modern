    ...
    const renderMatch = (match) => {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { style: {
                ...
                minWidth: '180px',
                        ...
                        borderRadius: '2px',
                    }, children: [(0, jsx_runtime_1.jsx)("span", { style: { fontSize: '0.875rem', fontWeight: match.winner === match.fencerA ? '600' : '400' }, children: match.fencerA ? `${match.fencerA.lastName} ${match.fencerA.firstName.charAt(0)}.` : '-' }), isEditing ? ((0, jsx_runtime_1.jsx)("input", { type: "number", value: tempScoreA, onChange: e => setTempScoreA(e.target.value), style: { width: '40px', textAlign: 'center' }, min: "0", max: maxScore, autoFocus: true })) : ((0, jsx_runtime_1.jsx)("span", { style: { fontWeight: '600' }, children: match.scoreA !== null ? match.scoreA : '' }))] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                        display: 'flex',
                        justifyContent: 'space-between',
                        padding: '0.25rem',
                        background: match.winner === match.fencerB ? '#dcfce7' : 'transparent',
                        borderRadius: '2px',
                    }, children: [(0, jsx_runtime_1.jsx)("span", { style: { fontSize: '0.875rem', fontWeight: match.winner === match.fencerB ? '600' : '400' }, children: match.fencerB ? `${match.fencerB.lastName} ${match.fencerB.firstName.charAt(0)}.` : '-' }), isEditing ? ((0, jsx_runtime_1.jsx)("input", { type: "number", value: tempScoreB, onChange: e => setTempScoreB(e.target.value), style: { width: '40px', textAlign: 'center' }, min: "0", max: maxScore })) : ((0, jsx_runtime_1.jsx)("span", { style: { fontWeight: '600' }, children: match.scoreB !== null ? match.scoreB : '' }))] }), match.isBye && ((0, jsx_runtime_1.jsx)("div", { style: { fontSize: '0.75rem', color: '#6b7280', textAlign: 'center', marginTop: '0.25rem' }, children: "Exempt" })), canEdit && !isEditing && ((0, jsx_runtime_1.jsx)("button", { onClick: () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { padding: '1rem' }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }, children: [(0, jsx_runtime_1.jsxs)("h2", { style: { fontSize: '1.25rem', fontWeight: '600' }, children: ["Tableau de ", tableauSize, " - ", ranking.length, " qualifi\u00E9s"] }), champion && ((0, jsx_runtime_1.jsxs)("div", { style: {
                    ...
                    borderRadius: '8px',
                            ...
                            overflowY: 'auto',
                                ...
                                borderRadius: '4px',
                                fontSize: '0.875rem',
                            }, children: [(0, jsx_runtime_1.jsxs)("span", { style: { fontWeight: '600', minWidth: '24px' }, children: [idx + 1, "."] }), (0, jsx_runtime_1.jsxs)("span", { children: [r.fencer.lastName, " ", r.fencer.firstName] }), (0, jsx_runtime_1.jsxs)("span", { style: { marginLeft: 'auto', color: '#6b7280' }, children: [(r.ratio * 100).toFixed(0), "%"] })] }, r.fencer.id))) })] })] }));
};
